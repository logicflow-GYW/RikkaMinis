...
echo "━━━ [2/13] i18n consistency check ━━━"
python3 -c "
import re, os, sys
root = '$ROOT'
...
echo "━━━ [3/13] Enum parse safety check ━━━"
...
echo "━━━ [4/13] Provider process-boundary guard ━━━"
...
echo "━━━ [5/13] Agent trace replay eval ━━━"
...
#   `legacy-ok: <reason>`.
echo "━━━ [6/13] Legacy pipeline guard ━━━"
...
echo "━━━ [7/13] Native crash-field host test ━━━"
...
echo "━━━ [8/13] Debug-code release boundary (source) ━━━"
...
echo "━━━ [9/13] Room migration chain ━━━"
...
echo "━━━ [10/13] Process-logging coverage ━━━"
...
echo "━━━ [11/13] AlarmClock EXTRA_DAYS container type ━━━"
...
echo "━━━ [12/13] Stale-closure guard ━━━"
...
# --- 13. Stream-flow dispatch guard (blocking cold flow on the collector) ---
...
echo "━━━ [13/13] Stream-flow dispatch guard ━━━"
