...
echo "━━━ [2/16] i18n consistency check ━━━"
python3 -c "
import re, os, sys
root = '$ROOT'
...
echo "━━━ [3/16] Enum parse safety check ━━━"
...
echo "━━━ [4/16] Provider process-boundary guard ━━━"
...
echo "━━━ [5/16] Agent trace replay eval ━━━"
...
#   `legacy-ok: <reason>`.
echo "━━━ [6/16] Legacy pipeline guard ━━━"
...
echo "━━━ [7/16] Native crash-field host test ━━━"
...
echo "━━━ [8/16] Debug-code release boundary (source) ━━━"
...
echo "━━━ [9/16] Room migration chain ━━━"
...
echo "━━━ [10/16] Process-logging coverage ━━━"
...
echo "━━━ [11/16] AlarmClock EXTRA_DAYS container type ━━━"
...
echo "━━━ [12/16] Stale-closure guard ━━━"
...
echo "━━━ [14/16] Stream-flow dispatch guard ━━━"
...
#   to be a static judgement.
echo "━━━ [15/16] Prefs listener holder guard ━━━"
...
echo "━━━ [16/16] Cross-process boundary completeness ━━━"
