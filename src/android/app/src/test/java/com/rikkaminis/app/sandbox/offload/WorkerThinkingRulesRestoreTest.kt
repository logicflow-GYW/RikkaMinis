...
import com.rikkaminis.app.provider.thinking.ThinkingWireFormat
...
class WorkerThinkingRulesRestoreTest {
    ...
    fun `encode covers scope pattern and echoes`() {
        val rule = clampRule().copy(
            ...
            reasoningEcho = com.rikkaminis.app.provider.thinking.ReasoningEchoPolicy(
                "reasoning_content",
                com.rikkaminis.app.provider.thinking.ReasoningEchoPolicy.Timing.EVERY_TURN,
            ),
        )
        ...
        assertEquals(
            "reasoning_content",
            (back2?.reasoningEcho as? com.rikkaminis.app.provider.thinking.ReasoningEchoPolicy)?.fieldName,
        )
