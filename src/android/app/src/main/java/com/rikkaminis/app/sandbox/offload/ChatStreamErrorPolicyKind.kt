 ...
 * [com.rikkaminis.app.ui.chat.ChatStreamErrorPolicy] on the main process side;
...
object ChatStreamErrorPolicyKind {
    ...
    fun of(t: Throwable): String? {
        ...
        while (cur != null && depth < 6) {
            when (cur) {
                is com.rikkaminis.app.data.model.LLMError.RateLimited -> return KIND_RATE_LIMITED
                is com.rikkaminis.app.data.model.LLMError.InvalidApiKey -> return KIND_INVALID_KEY
