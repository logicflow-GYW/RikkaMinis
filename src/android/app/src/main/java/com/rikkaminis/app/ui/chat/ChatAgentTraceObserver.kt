...
import com.rikkaminis.app.agent.runtime.BudgetExhaustedReason
...
internal class ChatAgentTraceObserver(
    ...
    private fun t7TotalOf(dimension: String): Int = when (dimension) {
        AgentTraceRecorder.DIMENSION_TURNS -> com.rikkaminis.app.data.AgentRuntimeLimitsPrefs.maxTurns()
        AgentTraceRecorder.DIMENSION_PROVIDER_ATTEMPTS -> com.rikkaminis.app.data.AgentRuntimeLimitsPrefs.maxProviderAttempts()
        AgentTraceRecorder.DIMENSION_TOOL_CALLS -> com.rikkaminis.app.data.AgentRuntimeLimitsPrefs.maxToolCalls()
        AgentTraceRecorder.DIMENSION_SHELL_COMMANDS -> com.rikkaminis.app.data.AgentRuntimeLimitsPrefs.maxShellCommands()
        AgentTraceRecorder.DIMENSION_COMPACTION_CALLS -> com.rikkaminis.app.data.AgentRuntimeLimitsPrefs.maxCompactionCalls()
        AgentTraceRecorder.DIMENSION_CONCURRENT_TOOLS -> com.rikkaminis.app.data.AgentRuntimeLimitsPrefs.maxConcurrentTools()
        else -> 0
    }
