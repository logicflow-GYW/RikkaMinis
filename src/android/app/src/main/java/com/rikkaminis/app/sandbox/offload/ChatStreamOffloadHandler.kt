...
/** First chunk arrived, then the stream went completely silent (no EOF,
     ...
     * [com.rikkaminis.app.sandbox.ExecutionCoordinator.maybeReclaimModelService]
    ...
    fun stream(
        ...
        val queueExtensionMs =
            if (com.rikkaminis.app.sandbox.offload.ProviderExecSlotPolicy.liveProviderSlots() > 1) streamTimeoutMs
            else 0L
