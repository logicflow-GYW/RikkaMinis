...
fun FileBrowserScreen(
    ...
    var webAppSheetSource by remember { mutableStateOf<com.rikkaminis.app.webapp.WebAppSource.HostFile?>(null) }
...
private fun FileItemRow(
    ...
    onClick: () -> Unit,
    onDelete: () -> Unit,
    onAddToHome: (com.rikkaminis.app.webapp.WebAppSource.HostFile) -> Unit,
) {
    ...
    run {
        ...
        com.rikkaminis.app.ui.components.MinisMenu(
            ...
            DropdownMenuItem(
                ...
                onClick = {
                    menuExpanded = false
                    val triple = com.rikkaminis.app.webapp.WebAppPathResolver.inferScope(item.file)
                    if (triple != null) {
                        val (scope, ctx, linuxPath) = triple
                        onAddToHome(
                            com.rikkaminis.app.webapp.WebAppSource.HostFile(
                                file = item.file,
                                fileName = item.name,
                                pathScope = scope,
                                scopeContext = ctx,
...
private fun MoreMenu(
    ...
    Box {
        ...
        com.rikkaminis.app.ui.components.MinisMenu(expanded = expanded, onDismissRequest = { expanded = false }) {
