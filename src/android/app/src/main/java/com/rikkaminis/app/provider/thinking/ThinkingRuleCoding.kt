...
object ThinkingRuleCoding {
    ...
    fun encodeWireFormat(fmt: ThinkingWireFormat?): String? {
        ...
        when (fmt) {
            ...
            is ThinkingWireFormat.DeepSeekRelay -> o.put("type", "deepseek_relay")
            is ThinkingWireFormat.QwenDual -> o.put("type", "qwen_dual")
            is ThinkingWireFormat.QwenRootOnly -> o.put("type", "qwen_root_only")
    ...
    fun decodeWireFormat(json: String?): ThinkingWireFormat? {
        ...
        return try {
            ...
            when (o.optString("type")) {
                ...
                "deepseek_relay" -> ThinkingWireFormat.DeepSeekRelay
                "qwen_dual" -> ThinkingWireFormat.QwenDual
                "qwen_root_only" -> ThinkingWireFormat.QwenRootOnly
