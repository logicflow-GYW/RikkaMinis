...
internal fun ChatViewModel.reportAgentLoopError(e: Exception) {
    if (e is com.rikkaminis.app.data.model.FallbackExhaustedError) {
        ...
        val errSummary = when (errActual) {
            is com.rikkaminis.app.sandbox.offload.ModelStreamErrorException ->
                context.getString(R.string.error_stream_interrupted)
            is com.rikkaminis.app.data.model.LLMError -> errActual.userMessage
