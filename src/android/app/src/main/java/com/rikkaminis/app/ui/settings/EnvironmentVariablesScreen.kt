...
fun EnvironmentVariablesScreen(
    ...
    val privacyEnabled by com.rikkaminis.app.data.EnvVarPrivacyStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = { com.rikkaminis.app.data.EnvVarPrivacyStore.setEnabled(it) },
                showDivider = false,
            )
        }
