...
/**
 * One configurable setting. Concrete kinds: [com.rikkaminis.app.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.rikkaminis.app.config.fields.ClosureField]
