...
import com.rikkaminis.app.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.rikkaminis.app.ui.settings.KEY_LANGUAGE
import com.rikkaminis.app.ui.settings.KEY_LAUNCH_SESSION
import com.rikkaminis.app.ui.settings.KEY_THEME_MODE
import com.rikkaminis.app.ui.settings.PREF_APPEARANCE
import com.rikkaminis.app.ui.settings.getAppearancePrefs
import com.rikkaminis.app.ui.settings.fontScaleForLevel
import com.rikkaminis.app.ui.settings.keepScreenAwakeEnabled
import com.rikkaminis.app.ui.theme.MinisTheme
...
class MainActivity : ComponentActivity() {
     ...
     * [com.rikkaminis.app.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.rikkaminis.app.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (com.rikkaminis.app.crash.CrashFrequencyDetector.isSafeMode() ||
            ...
            com.rikkaminis.app.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
                onClosed = { finish() },
        ...
        if (intent?.getBooleanExtra("shared_content", false) == true) {
            com.rikkaminis.app.share.ShareCoordinator.processPendingShare(this)
        }
        ...
        if (BuildConfig.DEBUG) {
            com.rikkaminis.app.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
        ...
        setContent {
            ...
            MinisTheme(darkTheme = darkTheme, fontScale = fontScale) {
                ...
                com.rikkaminis.app.ui.settings.ConfigConfirmDialogHost()
            }
        }
    }
     ...
     * is already covered by [com.rikkaminis.app.ui.navigation.AppNavigation]
