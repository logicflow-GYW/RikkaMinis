...
// [refactor/split-chatscreen] Top-level color constants, scroll/sentinel
// helpers, ScrollFollowKey moved verbatim to ChatScreenStatics.kt
// (SLASH_PICKER_FIXED_HEIGHT / verticalScrollbar private -> internal).
...
fun ChatScreen(
    ...
    skillRepository: com.rikkaminis.app.data.repository.SkillRepository? = null,
    ...
    // bufferVersion bump.
    val shareBufferVersion by com.rikkaminis.app.share.ShareCoordinator.bufferVersion.collectAsState()
    androidx.compose.runtime.LaunchedEffect(shareBufferVersion) {
        if (shareBufferVersion == 0) return@LaunchedEffect
        val pending = com.rikkaminis.app.share.ShareCoordinator.consumeBuffer(context)
        ...
        for (item in pending.items) {
            when (item.kind) {
                com.rikkaminis.app.share.PendingShare.Item.Kind.INLINE_TEXT -> {
                ...
                com.rikkaminis.app.share.PendingShare.Item.Kind.ATTACHMENT -> {
                    viewModel.addAttachmentFromStagedShare(java.io.File(sharedDir, item.value))
                }
            }
        }
        viewModel.markShareInjected()
        com.rikkaminis.app.share.SharedShareStore.cleanSharedFiles(context)
    }
    ...
    androidx.compose.runtime.LaunchedEffect(sessionId) {
        ...
        com.rikkaminis.app.diagnostics.HangDetector.markHealthyTick()
    }
    ...
    val cameraLauncher = rememberLauncherForActivityResult(
        ...
        com.rikkaminis.app.service.SessionActivityTracker.setCameraSuppressActive(false)
    ...
    val launchCamera: () -> Unit = {
        ...
        com.rikkaminis.app.service.SessionActivityTracker.setCameraSuppressActive(true)
    ...
    LaunchedEffect(sessionId) {
        val pending = com.rikkaminis.app.deeplink.DeepLinkCoordinator
            .pendingChatAction.value
        if (pending == com.rikkaminis.app.deeplink.DeepLinkCoordinator
                .ChatAction.OPEN_CAMERA
        ) {
            com.rikkaminis.app.deeplink.DeepLinkCoordinator
    ...
    val appearancePrefs = remember { com.rikkaminis.app.ui.settings.getAppearancePrefs(context) }
    var messageFontLevel by remember { mutableStateOf(appearancePrefs.getInt(com.rikkaminis.app.ui.settings.KEY_FONT_MESSAGE, 0)) }
    var chatInputLevel by remember { mutableStateOf(appearancePrefs.getInt(com.rikkaminis.app.ui.settings.KEY_FONT_CHAT_INPUT, 0)) }
    var toolPreviewEnabled by remember { mutableStateOf(appearancePrefs.getBoolean(com.rikkaminis.app.ui.settings.KEY_TOOL_PREVIEW, false)) }
    ...
    var toolStatusBarEnabled by remember { mutableStateOf(appearancePrefs.getBoolean(com.rikkaminis.app.ui.settings.KEY_TOOL_STATUS_BAR, true)) }
    // T-chat-title-pill: live-toggled by Settings → Appearance and by
    // `minis-config set appearance.show_chat_title …`. Default ON.
    var showChatTitlePill by remember { mutableStateOf(appearancePrefs.getBoolean(com.rikkaminis.app.ui.settings.KEY_SHOW_CHAT_TITLE, true)) }
    ...
    var editingSession by remember { mutableStateOf<com.rikkaminis.app.data.db.ChatSessionEntity?>(null) }
    DisposableEffect(appearancePrefs) {
        val listener = android.content.SharedPreferences.OnSharedPreferenceChangeListener { sp, key ->
            when (key) {
                com.rikkaminis.app.ui.settings.KEY_FONT_MESSAGE -> messageFontLevel = sp.getInt(key, 0)
                com.rikkaminis.app.ui.settings.KEY_FONT_CHAT_INPUT -> chatInputLevel = sp.getInt(key, 0)
                com.rikkaminis.app.ui.settings.KEY_TOOL_PREVIEW -> toolPreviewEnabled = sp.getBoolean(key, false)
                com.rikkaminis.app.ui.settings.KEY_TOOL_STATUS_BAR -> toolStatusBarEnabled = sp.getBoolean(key, true)
                com.rikkaminis.app.ui.settings.KEY_SHOW_CHAT_TITLE -> showChatTitlePill = sp.getBoolean(key, true)
            }
        }
    ...
    val markdownFontScale = com.rikkaminis.app.ui.settings.fontScaleForLevel(messageFontLevel)
    val chatInputFontScale = com.rikkaminis.app.ui.settings.fontScaleForLevel(chatInputLevel)
    ...
    var htmlPreviewHolder by remember {
        mutableStateOf<com.rikkaminis.app.ui.preview.WebViewHolder?>(null)
    }
    ...
    val openHtmlPreview = remember<(java.io.File, String) -> Unit>(appCtx) {
        { file, title ->
            ...
            if (existing == null || existing.currentUrl != url) {
                existing?.destroy()
                htmlPreviewHolder = com.rikkaminis.app.ui.preview.WebViewHolder(appCtx, url)
            }
    ...
    LaunchedEffect(sessionId) {
        ...
        com.rikkaminis.app.deeplink.DeepLinkCoordinator.consumePendingHtmlPreview()
        ...
        val file = com.rikkaminis.app.sandbox.PRootKernel.resolveHostPath(
    ...
    var previewImageGallery by remember {
        mutableStateOf<Pair<List<com.rikkaminis.app.ui.components.ImageGalleryItem>, Int>?>(null)
    }
        ...
        { url ->
            ...
            when (val action = ChatLinkResolver.resolve(url, viewModel.currentSessionId, context)) {
                ...
                is ChatLinkAction.ExternalApp ->
                    com.rikkaminis.app.ui.browser.BrowserExternalSchemeHandler
    ...
    val pendingMinisOpenUrl by com.rikkaminis.app.terminal.MinisOpenUrlBroker.pendingUrl
        .collectAsState()
    val minisOpenTerminalVisible by com.rikkaminis.app.terminal.MinisOpenUrlBroker.terminalVisible
        .collectAsState()
    LaunchedEffect(pendingMinisOpenUrl, minisOpenTerminalVisible) {
        ...
        com.rikkaminis.app.terminal.MinisOpenUrlBroker.consume()
    }
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            ...
            val draftSnapshot by com.rikkaminis.app.data.ComposerDraftStore
    ...
    Scaffold(
        ...
        Column(
            ...
            Box(modifier = Modifier.weight(1f)) {
                ...
                LazyColumn(
                    ...
                    items(
                        ...
                        com.rikkaminis.app.diagnostics.PerfLongCtx.maybeReportRowComposed(
                            sessionId,
                                        ...
                                        Modifier.onPlaced {
                                            ...
                                            if (!coldOpenSummaryEmitted) {
                                                ...
                                                messages.forEachIndexed { idx, m ->
                                                    if (m.content.length >= com.rikkaminis.app.diagnostics.CONTENT_DIAG_MIN_CHARS) {
            ...
            editingSession?.let { session ->
                com.rikkaminis.app.ui.sessions.SessionEditSheet(
                    session = session,
    ...
    htmlPreviewHolder?.let { holder ->
        ...
        if (htmlPreviewFullscreen) {
            ...
            com.rikkaminis.app.ui.preview.WebPreviewBottomSheet(
                holder = holder,
                fallbackTitle = htmlPreviewFallbackTitle,
    ...
    previewVideoFile?.let { file ->
        com.rikkaminis.app.ui.media.MinisFullscreenVideoPlayer(
            file = file,
    ...
    webAppSheetTarget?.let { target ->
        com.rikkaminis.app.webapp.AddToHomeSheet(
            source = com.rikkaminis.app.webapp.WebAppSource.ChatAttachment(
                uri = target.uri,
